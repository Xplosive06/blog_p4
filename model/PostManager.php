  ...
  class PostManager extends Database
  {
    ...
    public function get($id)
    {
      ...
      $q = $this->_db->query('SELECT id, title, content, DATE_FORMAT(creation_date, "%d/%m/%Y à %Hh%i") AS creation_date FROM posts WHERE id = '.$id);
    ...
    public function getList()
    {
      ...
      $q = $this->_db->query('SELECT id, title, content, DATE_FORMAT(creation_date, "%d/%m/%Y à %Hh%i") AS creation_date FROM posts ORDER BY creation_date DESC');
